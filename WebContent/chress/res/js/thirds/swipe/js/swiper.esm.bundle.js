...
self = this;
self
  eventsListeners...return) {
    self; let
    events;!let.data$$1;) let context;
    typeof args
    [0] 'string'
    Array [0]
          events = args[0];      data$$1 = args.slice(1, args.length);       context = self;
  constructor(params = {}) {
    const self = this;
    self.params = params;
...
class Swiper extends SwiperClass {
  args...let) {
    el; let
    params; length
    1.args === [0] && constructorargs.[0] && constructorObject.      params = args[0]; ===
constructor() {

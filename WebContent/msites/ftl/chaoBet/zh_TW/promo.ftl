    ...
    <section class="promo">
        <div class="container">
            <ul class="list-inline promo-sorts">
                ...
                <li class="hisActivityButton hide"><a href="javascript:void(0)" data-item="historyActivitys">歷史優惠</a></li>
            </ul>
            <dl class="sidePromo">
...
<#include "../../commonPage/zh_TW/msiteCommonContent/promoTip.ftl">
</main>
<#include "footer.ftl">
<#include "../../commonPage/commonFloat/gameAds.ftl">
<#include "script.ftl">
<#include "../../commonPage/zh_TW/msiteCommonScript/promoScript.ftl">

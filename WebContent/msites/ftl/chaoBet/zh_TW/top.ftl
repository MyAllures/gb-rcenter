                ...
                <div class="_vr_unLogin" style="display:none;">
                    <form class="form-inline">
                        ...
                        <div class="form-group account">
                            <input type="text" name="username"  tabindex="1"   maxlength="15" class="form-control" placeholder="會員賬號">
                            <a href="javascript:" onclick="forgetUsername()" class="forget">忘記?</a>
                        </div>
                        <div class="form-group password">
                            <input type="password" name="password"  tabindex="2"   maxlength="20" class="form-control" placeholder="密碼">
                        ...
                        <div class="form-group code _vr_captcha_box" style="display: none">
                            <input type="text" class="form-control" name="captcha" tabindex="3" maxlength="4" placeholder="驗證碼">
                            <img class="_vr_captcha_code" data-code="loginTop">
                        </div>
                        <a href="javascript:" type="button" class="btn-login _vr_login" tabindex="4">立即登入</a>

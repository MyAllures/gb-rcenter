...
<#assign apiType = "1">
<#-- api图片路径 -->
<#assign bgCover ={"1":"${data.configInfo.sitePath}/images/live-item-bg-ds.jpg","3":"${data.configInfo.sitePath}/images/live-item-bg-mg.jpg","5":"${data.configInfo.sitePath}/images/live-item-bg-gd.jpg","7":"${data.configInfo.sitePath}/images/live-item-bg-og.jpg","8":"${data.configInfo.sitePath}/images/live-item-bg-slc.jpg","9":"${data.configInfo.sitePath}/images/live-item-bg-ag.jpg","10":"${data.configInfo.sitePath}/images/live-item-bg-bb.jpg","16":"${data.configInfo.sitePath}/images/live-item-bg-ebet.jpg","17":"${data.configInfo.sitePath}/images/live-item-bg-sa.jpg","24":"${data.configInfo.sitePath}/images/live-item-bg-opus.jpg","33":"${data.configInfo.sitePath}/images/live-item-bg-shenbo.jpg"}>
<#assign bgCoverKeys = bgCover?keys>
<#--api logo-->
<#assign apiLogo ={"1":"${data.configInfo.sitePath}/images/live-logo-ds.png","3":"${data.configInfo.sitePath}/images/live-logo-mg.png","5":"${data.configInfo.sitePath}/images/live-logo-gd.png","7":"${data.configInfo.sitePath}/images/live-logo-og.png","8":"${data.configInfo.sitePath}/images/live-logo-slc.png","9":"${data.configInfo.sitePath}/images/live-logo-ag.png","10":"${data.configInfo.sitePath}/images/live-logo-bb.png","16":"${data.configInfo.sitePath}/images/live-logo-ebet.png","17":"${data.configInfo.sitePath}/images/live-logo-sa.png","24":"${data.configInfo.sitePath}/images/live-logo-opus.png","33":"${data.configInfo.sitePath}/images/live-logo-shenbo.png"}>

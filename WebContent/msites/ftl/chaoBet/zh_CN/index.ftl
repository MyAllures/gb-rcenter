                ...
                <div class="blo blo-sports">
                    ...
                    <div class="shadow">
                        <div class="icon-wrap">
                           ...
                           <#-- <#assign sportsApis = {"4":"IM体育","12":"皇冠体育","19":"沙巴体育"}/>
                            <#assign sportsApisKeys = sportsApis?keys/>
                            <#list sportsApisKeys as key>
                                <#if data.siteApiMap["${key}"]??>
                                    <a class="_vr_mt_check" data-href="sports.html?apiId=${key}" href="javascript:void(0)" data-api="${key}" data-apitype="3"
                                       <#if data.siteApiMap["${key}"].maintainStartTime?has_content>startTime="${data.siteApiMap["${key}"].maintainStartTime?long?string.computer}"</#if>
                                       <#if data.siteApiMap["${key}"].maintainEndTime?has_content>endTime="${data.siteApiMap["${key}"].maintainEndTime?long?string.computer}"</#if>>
                                        <span class="icon-game">${sportsApis[key]}</span></a>
                                </#if>
                            </#list>-->

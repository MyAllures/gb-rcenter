            ...
            <div class="game-type-wrap">
                <div class="blo blo-sports">
                    ...
                    <div class="shadow">
                        ...
                        <a href="sports.html?apiId=<#list data.siteApiTypeRelationMap['3'] as relationMap><#if relationMap_index==0>${relationMap.apiId?string.computer}</#if></#list>" class="btn-tz">Immediate Betting</a>
                    </div>
                ...
                <div class="blo blo-casino">
                    ...
                    <div class="shadow">
                        ...
                        <a href="casino.html?apiType=2&apiId=<#list data.siteApiTypeRelationMap['2'] as relationMap><#if relationMap_index==0>${relationMap.apiId?string}</#if></#list>&gameTag=<#list data.gameTagsOfApiType as tag><#if tag_index == 0>${tag.key}</#if></#list>" class="btn-tz">Immediate Betting</a>
                    </div>

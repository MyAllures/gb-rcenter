            ...
            <div class="main wi">
                ...
                <div class="rt">
                        ...
                        <ul>
                            <!--<li>
                                <a href="javascript:void(0)">
                                    <div class="pict">
                                        <i><img src="${data.configInfo.sitePath}/themes/images/help/ico208.png" alt=""></i>
                                    </div>
                                    <div class="text">
                                        <p>修改资料</p>
                                    </div>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="pict">
                                        <i><img src="${data.configInfo.sitePath}/themes/images/help/ico209.png" alt=""></i>
                                    </div>
                                    <div class="text">
                                        <p>会员中心</p>
                                    </div>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="pict">
                                        <i><img src="${data.configInfo.sitePath}/themes/images/help/ico210.png" alt=""></i>
                                    </div>
                                    <div class="text">
                                        <p>修改密码</p>
                                    </div>
                    ...
                    <div class="help_problem">
                        <h5>安全保障</h5>
                        <ul>
                            <li><a href="aq_1.html">1.购彩支付和充值安全</a></li>
                            <li><a href="aq_2.html">2.账户资金安全</a></li>
                            <li><a href="aq_3.html">3.个人隐私安全</a></li>
                            <li><a href="aq_4.html">4.购彩优势</a></li>
                        </ul>
                    </div>
                </div>
            </div>

                ...
                <div class="rt">
                    ...
                    <div class="help_list">
                        ...
                        <div class="help_col show">
                            ...
                            <p>
                                <strong>第一步</strong>：登录后，点击“<span style="color:#E53333;">会员中心</span>”，进入“会员中心”。点击“<span
                                    style="color:#E53333;">账户设置</span>”。</p>
                            <p style="text-align: center">
                                <a href="${data.configInfo.sitePath}/themes/images/help/zc6.png"> <img
                                        src="${data.configInfo.sitePath}/themes/images/help/zc6.png" title="点击放大图片"
                                        width="700"></a>
                            </p>
                            <h3 style="text-align: center;color: #fa4100">(点击图片放大) &nbsp;↑</h3>
                            <br>
                            <p style="text-align: center">
                                <a href="${data.configInfo.sitePath}/themes/images/help/zc7.png"> <img
                                        src="${data.configInfo.sitePath}/themes/images/help/zc7.png" title="点击放大图片"
                                        width="700"></a>
                            </p>
                            ...
                            <p style="text-align: center">
                                <a href="${data.configInfo.sitePath}/themes/images/help/zc8.png"> <img
                                        src="${data.configInfo.sitePath}/themes/images/help/zc8.png" title="点击放大图片"
                                        width="700"></a>
                            </p>
                            <h3 style="text-align: center;color: #fa4100">(点击图片放大) &nbsp;↑</h3>
                            <br>
                            ...
                            <p style="text-align: center">
                                <a href="${data.configInfo.sitePath}/themes/images/help/zc9.png"> <img
                                        src="${data.configInfo.sitePath}/themes/images/help/zc9.png" title="点击放大图片"
                                        width="700"></a>
                            </p>
                            <h3 style="text-align: center;color: #fa4100">(点击图片放大) &nbsp;↑</h3>
                        </div>

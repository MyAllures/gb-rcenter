            ...
            <div class="main wi">
                    ...
                    <ul>
                        ...
                        <li class="li1  zhinan">
                            ...
                            <div class="slide" style="display:block;">
                                ...
                                <p class="acti"><a href="cz.html">充值</a></p>
                ...
                <div class="rt">
                    ...
                    <div class="help_problem">
                        ...
                        <h4>关于充值</h4>
                        <ul>
                            <li><a href="cz_1.html">1. 在线支付？</a></li>
                            <li><a href="cz_3.html">2. 网银存款？</a></li>
                            <li><a href="cz_2.html">3. 扫码支付?</a></li>
                            <li><a href="cz_4.html">4. 电子支付？</a></li>
                            <li><a href="cz_5.html">5. 柜员机/柜台存款？</a></li>
                        </ul>
                    </div>
                </div>
            </div>

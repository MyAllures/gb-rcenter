                ...
                <div class="rt">
                    <div class="type1">
                        ...
                        <div class="step">
                            <ul>
                                ...
                                <li><a href="javascript:void(0)" onclick="openHyzx('zhcz/yhzz')"><img
                                        src="${data.configInfo.sitePath}/themes/images/help/ico204.png" alt="">账户充值</a></li>
                                <li><a href="javascript:void(0)" onclick="openGcdt()"><img
                                ...
                                <li><a href="javascript:void(0)" onclick="openHyzx('withdraw')"><img
                    ...
                    <div class="help_list">
                        ...
                        <div class="help_col show">
                            ...
                            <p>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;彩票网（www..com），是一家专注于的网络彩票投注和服务的互联网公司。<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我们立志通过互联网的技术应用和专心致志的服务理念，确保能为您提供一个便捷、安全、高效、专业的购彩平台。</p>
                            <p>
                                <strong>一、购彩便捷，玩法丰富</strong> <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;彩票网现提供全国主流彩票在线业务，您只需在注册一个账户，投注、兑奖、提现都可轻松完成！</p>
                            <p><strong>二、资深团队，确保服务专业</strong> <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;彩票团队均有资深行业从业经验和强大的技术背景优势，为用户提供专业、高效和便捷的交易环境。确保平台能每天24小时持续运营，为客户不间断提供专业化服务。
                            </p>
                            <p><strong>三、网银充值与提款均不收取手续费</strong> <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我们推出“网银零手续费”服务标准，您可以选择网上银行支付，所产生的转账费用由本站承担，您支付多少即到帐多少。正常提款本站也不收取任何提款手续费。
                            </p>

                            <p><strong>四、提款全网快速到账</strong> <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提款处理时间：本站09：30-17：30为您处理提款（如遇法定节假日，提款处理时间公告通知用户）。
                                银行到账时间：正常提款，最快10分钟到账，所有银行预计24小时可到账。节假日因银行系统处理不及时造成的延误，预计在假期后第一个工作日到账。</p>
                            <p><strong>五、多层账户安全，确保投注无忧</strong> <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;每个购彩账户需要绑定真实的身份信息和银行卡信息方可提款，一旦绑定后不允许自行修改，多层次技术比对，可确保账户资金安全。
                            </p>

                    ...
                    <ul>
                        <li class="li1 sli">
                            ...
                            <div class="slide" style="display:block;">
                                ...
                                <p class="acti"><a href="pl3.html">体彩排列3</a></p>
                ...
                <div class="rt">
                    ...
                    <div class="help_list">
                        ...
                        <div class="help_col show">
                            ...
                            <p><strong>◎二字定位</strong><br>于百十个任选二位，自0~9任选2个号进行投注，当开奖结果与所选号码相同且顺序一致时，即为中奖。<br>※举例：投注者购买二字百十定位，选择号码为百位1、十位2，当期开奖结果如果只要百位与十位皆与其所选的号码相同且顺序一致时，个位数无论为12x皆视为中奖。（x=0~9任一数）
                            </p>
                        ...
                        <div class="help_col">
                            ...
                            <p>排列三是依照中国体彩管理中心发行的排列三的开奖结果为派彩依据，开奖时间是每天晚上八点，每天开奖一次。假设排列三开奖结果为 123，那么百位是 1，十位是 2，个位是
                                3。(每个位数在开奖时从 0 ~ 9 中摇出一个结果)；本公司排列三具体游戏规则请参考彩种介绍。</p>
                        </div>
                    </div>
                </div>
            </div>

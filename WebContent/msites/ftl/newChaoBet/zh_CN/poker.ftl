...
<main class="main-lottery  main-poker">
    <div style="height: 406px;background: url(${data.configInfo.sitePath}/images/poker-banner.jpg) no-repeat center bottom;"></div>
    <!-- notice -->
    <#include "notice.ftl">
    <!-- Lottery -->
    <section class="ky-poker">

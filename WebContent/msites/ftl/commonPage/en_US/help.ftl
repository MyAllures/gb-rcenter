<#--旧版,待删除：如需引用，请引用<#include "../../commonPage/en_US/msiteCommonContent/help.ftl">-->
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="branding text-white">
                        <img src="${imgPath(data.configInfo.domain,data.configInfo.logo)}" class="tamashi-logo"> | Help center
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <#-- 子项下是否有相关问题 -->
                            ...
                            <div class="col-sm-9 help-content content_parent_${parent.typeId}_${children.typeId}" style="display: none">
                                <div class="panel panel-default">
                                        <div class="panel-heading"><strong>${children.name}</strong> Total <span class="label label-warning counts">10</span> related question </div>
    ...
    <div class="server-bar">
        <button class="btn btn-block flat-btn -blue -xs" type="button" onclick='window.open("<#if data.defaultCustomerService?exists>${data.defaultCustomerService}</#if>")'>Customer service</button>

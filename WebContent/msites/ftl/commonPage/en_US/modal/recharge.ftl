    ...
    <div class="col-12-12">
        <form class="form-horizontal" id="loginForm" method="post" action="#">
            <div class="row recharge-item">
                <div class="col-12-2 text">Turn out</div>
                <div class="col-12-3 title">My wallet</div>
                <div class="col-12-5 value"><span id="walletBalance-value"></span> <a href="javascript:refreshWalletBalance()"><span class="pull-right gui gui-refresh" id="wallet-refresh-span"></span></a></div>
                <div class="col-12-2">
                    <a class="btn btn-primary" data-win-size="2" target="_blank" href="${data.contextInfo.playerCenterContext}#/fund/playerRecharge/recharge.html">Go to deposit</a>
                    <#--<a class="btn btn-primary" href="">去充值</a>-->
                </div>
            </div>
            <div class="row recharge-item">
                <div class="col-12-2 text">top-up</div>
                <div class="col-12-3 title" id="api-name-div"></div>
                <div class="col-12-5 value"><span id="apiBalance-value"></span> <a href="javascript:refreshApiBalance()"><span class="pull-right gui gui-refresh" id="api-refresh-span"></span></a></div>
                <div class="col-12-2"></div>
            </div>
            <div class="row recharge-item">
                <div class="col-12-3 col-offset-12-2 title">￥</div>
                <div class="col-12-5 value">
                    <input type="text" class="form-control" id="transferAmount" name="transferAmount" placeholder="Please enter integer amount">
                    <span></span>
            ...
            <div class="row recharge-item">
                <div class="col-12-8 col-offset-12-2 sum-btn submit-btn-confirm">
                    <button class="btn btn-primary btn-block" type="button" id="confirm-btn" onclick="confirmTransction()">
                        <span class="gui gui-check-square-o"></span> Confirm transfer
                    </button>
                </div>
            </div>
            <div class="row recharge-item recharge-last ">
                <div class="col-12-8 col-offset-12-2 sum-btn enter-btn">
                    <button class="btn btn-success btn-block" type="button" onclick="enterToGame()"><span class="gui gui-share"></span> enter the game</button>
                </div>
            </div>
        </form>
    </div>

<#--旧版,待删除：如需引用，请引用<#include "../../commonPage/en_US/msiteCommonContent/signUp-agent.ftl">-->
<!DOCTYPE html>
<html lang="en">
...
<div class="container-fluid no-full">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h3 class="text-center text-white m-t-sm m-b-lg">Agent Register</h3>
        </div>
    </div>
</div>
<!--Login-->
    ...
    <div class="row">
        <div class="signin-card col-md-8 col-md-offset-2 register">
                ...
                <#list data.agentFieldSorts as field>
                    <#if field.name == 'regCode'>
                        <div class="form-group" id="recommendBox">
                            <label for="appid" class="col-sm-2 control-label">Introducer</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="recommendUserInputCode" placeholder="Please enter Introducer ">
                            </div>
                        </div>
                    </#if>
                </#list>
            ...
            <#if data.agentFieldSorts?has_content>
                <#list data.agentFieldSorts as field>
                    <#if field.name == 'username'>
                        <div class="form-group">
                            <label for="sysUser.username" class="col-sm-2 control-label">Account</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="sysUser.username" maxlength="15" placeholder="Please enter 4-15 characters account">
                            </div>
                        </div>
                    </#if>
                    ...
                    <#if field.name == 'password'>
                        <div class="form-group">
                            <label for="sysUser.password" class="col-sm-2 control-label">Login password</label>
                            <div class="col-sm-10">
                                <input type="password" class="form-control noCp" name="sysUser.password" maxlength="20" placeholder="Please enter password ">
                        ...
                        <div class="form-group">
                            <label for="confirmPassword" class="col-sm-2 control-label">Password confirm</label>
                            <div class="col-sm-10">
                                <input type="password" class="form-control noCp" name="confirmPassword" maxlength="20" placeholder="Please enter again">
                            </div>
                        </div>
                    </#if>
                    ...
                    <#--时区-->
                        <div class="form-group">
                            <label for="sysUser.defaultTimezone" class="col-sm-2 control-label">Timezone</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == 'sex'>
                        <div class="form-group">
                            <label for="sysUser.sex" class="col-sm-2 control-label">Sex</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == 'nickName'>
                        <div class="form-group">
                            <label for="sysUser.nickname" class="col-sm-2 control-label">nickname</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="sysUser.nickname" maxlength="30" placeholder="Please enter 4-15 characters">
                            </div>
                        </div>
                    </#if>
                    <#if field.name == 'defaultLocale'>
                        <div class="form-group">
                            <label for="sysUser.defaultLocale" class="col-sm-2 control-label">Main language</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == '304'>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Wechat</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="weixin.contactValue" placeholder="Please enter wechat">
                            </div>
                        </div>
                    </#if>
                    <#if field.name == '110'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="phone.contactValue" placeholder="Please enter correct phone number ,used for receive information">
                            </div>
                        </div>
                    </#if>
                    <#if field.name == '201'>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Mail</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="email.contactValue" placeholder="Please enter correct mail address ,used for receive information">
                            </div>
                        </div>
                        <#if data.agentValidateRegisterMap['isEmailValid']?exists && data.agentValidateRegisterMap['isEmailValid']>
                            ...
                            <#--<div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="inputPassword" class="col-sm-2 control-label">Mail verification code</label>
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="emailCode" maxlength="6" placeholder="Mail verification code">
                                            <span class="input-group-btn"><a class="btn primary-btn -white -sm" onclick="validateEmailAddress(this)">get verification code</a></span>
                                        </div>
                                    </div>
                                </div>
                            </#if>
                    ...
                    <#--TODO 下拉生日-->
                        <div class="form-group">
                            <label for="sysUser.birthday" class="col-sm-2 control-label">Birthday</label>
                    ...
                    <#if field.name == 'paymentPassword'>
                        <div class="form-group">
                            <label for="sysUser.permissionPwd" class="col-sm-2 control-label">Security password</label>
                            <div class="col-sm-10">
                                <input class="form-control noCp" maxlength="6" type="password" name="sysUser.permissionPwd">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="confirmPermissionPwd" class="col-sm-2 control-label">Confirm security password</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == 'realName'>
                        <div class="form-group">
                            <label for="sysUser.realName" class="col-sm-2 control-label">Real name</label>
                            <div class="col-sm-10">
                    ...
                    <#--安全问题-->
                        <div class="form-group">
                            <label for="sysUserProtection.question1" class="col-sm-2 control-label">Security question</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="sysUserProtection.answer1" class="col-sm-2 control-label">Enter</label>
                            <div class="col-sm-10">
                    ...
                    <#--主货币-->
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="sysUser.defaultCurrency">Main currency</label>
                            <div class="col-sm-10">
                                ...
                                <p class="help-block form-help">
                                    <span class="fa fa-info-circle fa-question-circle text-warning"></span>
                                    The main currency is your currency unit at the site, used for deposit, transfer, withdrawals！
                                                <span class="text-warning">
                                                    Once set up ,can not be modified ！
                                                </span>
                                </p>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <label for="inputPassword" class="col-sm-2 control-label">Verification code</label>
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="hidden" name="regtype" value="a">
                            <input type="text" class="form-control input-lowercase" name="captchaCode" maxlength="4" placeholder="Verification code">
                ...
                <button type="button" class="btn primary-btn -blue -lg" onclick="registerPlayer(this)">Submit registration</button>
            </form>
        </div>
        <div class="col-md-4 col-md-offset-4 text-center text-white m-t-sm">
            <p>已经是我们的代理?<a class="btn btn-link btn-lg no-vertical" href="${data.contextInfo.agentCenterContext}/passport/login.html">login</a></p>
        </div>
    </div>
</div>
<!--Server Bar-->
<div class="server-bar">
    <button class="btn btn-block flat-btn -blue -xs" type="button" onclick="getCustomerService()">Customer service </button>
        ...
        if ($form.valid()) {
            ...
            $.ajax({
                ...
                error: function (errMsg) {
                    $this.removeAttr("disabled").text("Submit registration");
...
//                    $this.removeAttr("disabled").text("提交注册");
    ...
    (function(){
        ...
        for(;currentYear > years-100;currentYear--){
            $('[name=birthdayYear]').append('<option value="'+currentYear+'">'+(currentYear)+'</option>')
        }
    })();
                        ...
                        emailCheckCountBackTimer = setInterval(
                                function(){
                                    ...
                                    if(!sendEmailIntervalSec){
                                        ...
                                        $this.text(sendEmailIntervalSec+" seconds after the re-send")
                                    }

...
<div class="game_side">
    ...
    <div class="g-s-api-tab">
        <a href="javascript:" class="active" data-api="i-casino"><span class="icon i-casino "></span><span class="txt">CASINO</span></a>
        <a href="javascript:" data-api="i-fish"><span class="icon i-fish"></span><span class="txt">FISH</span></a>
        <a href="javascript:" data-api="i-live"><span class="icon i-live"></span><span class="txt">LIVE</span></a>
        <a href="javascript:" data-api="i-sports"><span class="icon i-sports"></span><span class="txt">SPORTS</span></a>
        <a href="javascript:" data-api="i-lottery"><span class="icon i-lottery"></span><span class="txt">LOTTERY</span></a>
    </div>
                ...
                <#if apiTypeId=="2">
                    <li>
                        <a class="_vr_mt_check" data-api="34" href="/casino.html?apiType=2&amp;apiId=34" data-apitype="5" data-href="/casino.html?apiType=5&amp;apiId=34">
                            ...
                            <span class="txt">Kaiyuan chess</span>
                        </a>
                    </li>
                </#if>
            </#if>
...
<div class="game_bottom">
    <div class="small-bar">
        <div class="pull-left">
            ...
            <ul class="list-inline">
                <li><a href="javascript:" data-api="" onclick="myCollectList(this)"><span class="z1"><span class="icon i-fav"></span>my collection</span></a></a></li>
                <li><a href="javascript:" data-api="" onclick="myRecentlyList(this)" data-gametype="rec"><span class="z1"><span class="icon i-rec"></span>Recently played</span></a></li>
                <li><a href="javascript:" data-api="" onclick="gameTagList(this)" data-tag="hot_game"><span class="z1"><span class="icon i-hot"></span>top games</span></a></a></li>
                <li><a href="javascript:" data-api="" onclick="gameTagList(this)" data-tag="${data.gameSearch.gameTag?default('')}"><span class="z1"><span class="icon i-sam"></span>Similar games</span></a></a></li>
            </ul>
        </div>
        <div class="pull-right">
            <div class="search-box header-login _vr_gameSearch">
                ...
                <input type="text" name="gameName" class="form-control input-sm pull-left" placeholder="Please enter the game name">
                <a href="javascript:void(0)" class="btn btn-search pull-left _vr_gameSubmit"> Search</a>
            </div>
        </div>
    </div>
    ...
    <div class="_vr_gameNoContent hide">
        <div class="col-1-1" style="text-align: center;line-height: 140px"><span class="text-center text-warning h5">no content yet！</span></div>
    </div>
</div>
<!--游戏详情页-->
<div class="game-detail">
    <div class="body">
        <a href="javascript:void(0);" title="Exit Full Screen" class="exit-fullscreen" onclick="exitFullscreen();"></a>
                ...
                <div class="game-info-content">
                    ...
                    <div class="game-extra-info">
                        ...
                        <div class="extra-item">
                            ...
                            <span class="txt">score<span class="gameScore" data-score=""></span></span>
                        </div>
                        <div class="extra-item">
                                        <span class="icon">
                                            <a href="javascript:" onclick="gameFullScreen();" class="full_screen"></a>
                                        </span>
                            <span class="txt">Full-screen games</span>
                        </div>
                        <div class="extra-item hidden">
                                        <span class="icon">
                                            <a href="javascript:" class="icon-info"></a>
                                        </span>
                            <span class="txt gameDetail">game introduction</span>
                        </div>

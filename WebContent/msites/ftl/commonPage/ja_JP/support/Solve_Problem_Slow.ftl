...
<body>
    <div class="wrapper">
        <div class="conTent">
            <div class="conTop" style="background-image: url(${data.configInfo.ftlRootPath}commonPage/ja_JP/support/images/icon_Slow_bg.png)">
            ...
            <div class="soluTions">
                ...
                <#--<div class="solveBox">
                    ...
                    <img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/support/images/icon_Obtain.png" />
                    <h1>获取备用网址</h1>
                    <p>点选获取其他网址</p>
                    <div class="pushButton">
                        <a href="#">备用网址</a>

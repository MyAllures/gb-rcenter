...
<head>
    ...
    <title><#if data.siteInfo.title?default('')!=''>${data.siteInfo.title}<#else >${data.siteInfo.siteName}</#if>—モバイル版トピックス—モバイル専用</title>
...
<body class="index-page">
        ...
        <div class="header">
            <div class="container">
                ...
                <ul class="menu list-inline">
                    <li class="active"><a href="index.html?c=<#if mobileTopic??>${mobileTopic}<#else>default</#if>">モバイル版トピックス<small>最新アップ</small></a></li>
        ...
        <div class="section index">
            <div class="container">
                <div class="left left0">
                    <a href="download.html" title="APPをダウンロードします"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-01.png" class="img-left0"></a>
                    <div class="left0-2"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-02.png" class="img-left0-2"></div>
                    <div class="left0-3"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-03.png" class="img-left0-3"></div>
                    <div class="left0-4"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-04.png" class="img-left0-4"></div>
                    <div class="left0-5"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-05.png" class="img-left0-5"></div>
                    <div class="left0-6 flash2">
                        <#--<img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/qcode.png">-->
                            <div id="qcode"></div>
                        <p>スキャンしてダウンロードしてください。</p>
                        <p>最新APPをご体験ください。</p>
                    </div>
                </div>
                <div class="right right0">
                    <a href="games.html" title="人気ゲーム紹介"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-title-01.png" class="flash"></a>
                    <div class="right0-2"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-title-02.png" class="img-right0-2"></div>
                    <div class="right0-3"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-08.png" class="img-right0-3"></div>
                </div>
                <div class="top top0">
                    <img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-06.png" class="img-top0">
                    <div class="top0-2"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-10.png" class="img-top0-2"></div>
                </div>
                <div class="bottom bottom0">
                    <img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-07.png" class="img-bottom0">
                    <div class="bottom0-2"><img src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/images/index-09.png" class="img-bottom0-2"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/js/TweenMax.min.js"></script>
    <script src="${data.configInfo.ftlRootPath}commonPage/ja_JP/mobileTopic/js/jquery-parallax.js"></script>

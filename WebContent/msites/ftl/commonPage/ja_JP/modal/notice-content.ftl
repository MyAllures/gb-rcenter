...
<div class="msgbox">
    ...
    <div class="text-center">
        ...
        <#if data.pagingMap[msgKey]?exists>
            ...
            <#else>
                <li onclick="noticeChangePageAjax(this)" data-page-num="${data.pagingMap[msgKey].pageNumber - 1}">
                    <a>«</a></li>
            </#if>
            <#list data.pagingMap[msgKey].midBeginPage..data.pagingMap[msgKey].midEndPage as n>
                ...
                <#else>
                    ...
                    <#-- 分页中的 [N ... 尾页]-->
                        ...
                        <li <#if data.pagingMap[msgKey].pageNumber == n>class="active"</#if>
                            data-page-num="${data.pagingMap[msgKey].lastPageNumber}"
                            onclick="noticeChangePageAjax(this)"><a>${data.pagingMap[msgKey].lastPageNumber}</a></li>
                    <#else>
                        <li data-page-num="${n}" <#if data.pagingMap[msgKey].pageNumber == n>class="active"</#if>
                            onclick="noticeChangePageAjax(this)"><a>${n}</a></li>
                    </#if>
                </#if>
            </#list>

...
<#if data.helpCenterCategories??>
    <#list data.helpCenterCategories as parent>
        ...
        <li><a class="openNewWindow"
               data-url="commonPage/msiteCommonContent/help.html?pageNumber=${parent.typeId}&pagingKey=hpdc"
...
<#if data.helpCenterCategories??>
    <#list data.helpCenterCategories as parent>
        ...
        <li><a class="openNewWindow"
               data-url="commonPage/msiteCommonContent/help.html?pageNumber=${parent.typeId}&pagingKey=hpdc&w=${parent.typeId}"

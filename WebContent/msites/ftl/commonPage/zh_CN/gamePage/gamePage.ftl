...
<div class="game_side">
    ...
    <div class="g-s-api-tab">
        <a href="javascript:" class="active" data-api="i-casino"><span class="icon i-casino "></span><span class="txt">电子</span></a>
        <a href="javascript:" data-api="i-fish"><span class="icon i-fish"></span><span class="txt">捕鱼</span></a>
    ...
    <div class="small-bar">
        <div class="pull-left">
            ...
            <ul class="list-inline">
                ...
                <li><a href="javascript:" data-api="" onclick="gameTagList(this)" data-tag="hot_game"><span class="z1"><span class="icon i-hot"></span>热门游戏</span></a></a></li>
                <li><a href="javascript:" data-api="" onclick="gameTagList(this)" data-tag="${data.gameSearch.gameTag?default('')}"><span class="z1"><span class="icon i-sam"></span>类似游戏</span></a></a></li>
            </ul>
        </div>

...
<script>
    ...
    $("#login-agreement").on("click",function() {
        layerDialogRegister('<div class="register-content-wrap" style="overflow: hidden;outline: none;height:  100%;padding-right:  8px;margin-right: -8px;"><div class="col-md-12"><#compress><#if data.playerValidateRegisterMap.regProtocol??> ${data.playerValidateRegisterMap.regProtocol.value?replace('\n','')?replace('\r','')}</#if></#compress></div><div class="after"></div></div>','会员注册协议','layui-layer-brand',['640px','582px'],false,false);
    });

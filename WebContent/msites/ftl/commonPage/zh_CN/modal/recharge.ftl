    ...
    <div class="col-12-12">
        <form class="form-horizontal" id="loginForm" method="post" action="#">
            <div class="row recharge-item">
                <div class="col-12-2 text">转出</div>
                <div class="col-12-3 title">我的钱包</div>
            ...
            <div class="row recharge-item">
                <div class="col-12-2 text">转入</div>
            ...
            <div class="row recharge-item">
                ...
                <div class="col-12-5 value">
                    <input type="text" class="form-control" id="transferAmount" name="transferAmount" placeholder="请输入整数金额">
                    <span></span>
            ...
            <div class="row recharge-item">
                <div class="col-12-8 col-offset-12-2 sum-btn submit-btn-confirm">
                    <button class="btn btn-primary btn-block" type="button" id="confirm-btn" onclick="confirmTransction()">
                        <span class="gui gui-check-square-o"></span> 确认转账
                    </button>
                </div>
            </div>
            <div class="row recharge-item recharge-last ">
                <div class="col-12-8 col-offset-12-2 sum-btn enter-btn">
                    <button class="btn btn-success btn-block" type="button" onclick="enterToGame()"><span class="gui gui-share"></span> 进入游戏</button>
                </div>
            </div>
        </form>
    </div>

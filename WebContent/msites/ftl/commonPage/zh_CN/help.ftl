<#--旧版,待删除：如需引用，请引用<#include "../../commonPage/zh_CN/msiteCommonContent/help.ftl">-->
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="branding text-white">
                        <img src="${imgPath(data.configInfo.domain,data.configInfo.logo)}" class="tamashi-logo"> | 帮助中心
                    </div>
                </div>
            </div>
        </div>

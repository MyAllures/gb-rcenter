...
<div class="wrapper">
    <div class="conTent">
        <div class="conTop" style="background-image: url(${data.configInfo.ftlRootPath}commonPage/zh_TW/support/images/icon_404_bg.png);">
        ...
        <div class="soluTions">
            ...
            <div class="solveBox">
                ...
                <div class="pushButton">
                    ...
                    <a href="ClearDNS_File_A.html">手動設定</a>
                </div>
            </div>
            <div class="solveBox">

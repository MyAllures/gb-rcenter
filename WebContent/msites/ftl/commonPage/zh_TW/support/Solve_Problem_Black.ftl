...
<div class="wrapper">
    <div class="conTent">
        <div class="conTop" style="background-image: url(${data.configInfo.ftlRootPath}commonPage/zh_TW/support/images/icon_Black_bg.png);">
        ...
        <div class="soluTions">
            ...
            <div class="solveBox">
                ...
                <p>下載工具，一鍵修改DNS</p>
                <div class="pushButton">
                    <a href="javascript:" id="dns" target="_blank">下載DNS修改工具</a>
                    <a href="ClearDNS_File_za.html">手動設定</a>
                </div>
            </div>
            <div class="solveBox">

...
<div class="game_side">
    ...
    <div class="g-s-api-tab">
        ...
        <a href="javascript:" data-api="i-fish"><span class="icon i-fish"></span><span class="txt">捕魚</span></a>
        <a href="javascript:" data-api="i-live"><span class="icon i-live"></span><span class="txt">真人</span></a>
        <a href="javascript:" data-api="i-sports"><span class="icon i-sports"></span><span class="txt">體育</span></a>
...
<div class="game_bottom">
    <div class="small-bar">
        <div class="pull-left">
            ...
            <ul class="list-inline">
                <li><a href="javascript:" data-api="" onclick="myCollectList(this)"><span class="z1"><span class="icon i-fav"></span>我的收藏</span></a></a></li>
                <li><a href="javascript:" data-api="" onclick="myRecentlyList(this)" data-gametype="rec"><span class="z1"><span class="icon i-rec"></span>最近玩過</span></a></li>
                <li><a href="javascript:" data-api="" onclick="gameTagList(this)" data-tag="hot_game"><span class="z1"><span class="icon i-hot"></span>熱門遊戲</span></a></a></li>
                <li><a href="javascript:" data-api="" onclick="gameTagList(this)" data-tag="${data.gameSearch.gameTag?default('')}"><span class="z1"><span class="icon i-sam"></span>類似遊戲</span></a></a></li>
            </ul>
        </div>
    ...
    <div class="_vr_gameNoContent hide">
        <div class="col-1-1" style="text-align: center;line-height: 140px"><span class="text-center text-warning h5">暫無內容！</span></div>
    </div>
</div>
<!--游戏详情页-->

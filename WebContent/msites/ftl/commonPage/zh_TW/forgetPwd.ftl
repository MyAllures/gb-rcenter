<#--旧版,待删除：如需引用，请引用<#include "../../commonPage/zh_TW/msiteCommonContent/forgetPwd.ftl">-->
<!DOCTYPE html>
                        ...
                        <div class="tab-content m">
                            ...
                            <#--<form class="form-horizontal" id="" method="post" action="#">-->
                                ...
                                <#--//add by Bruce.Q-->
                                    <a href="javascript:" class="list-group-item _phoneCanUse" style="display: none"  data-find-type="phone">
                                        <h4 class="list-group-item-heading text-info">手機驗證</h4>
                                        <p class="list-group-item-text">若您賬戶繫結的手機號碼<span class="text-info"  player-phone=""></span>仍在正常使用中，請選擇此驗證方式。</p>
                                    </a>
                                ...
                                <div find-way="email" style="display: none" class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn"><a class="btn primary-btn -white -sm" id="resendBtn" onclick="sendEmailByUserName()">傳送驗證碼</a></span>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                            ...
                            <#--手機驗證碼驗證-->
                                <div find-way="phone" style="display: none" class="form-group">
                                    <label class="col-sm-3 control-label">繫結手機號</label>
                                    <div class="col-sm-6">
                                ...
                                <div find-way="phone" style="display: none" class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="phoneCode"  maxlength="6" placeholder="請輸入驗證碼">
                                            <span class="input-group-btn"><a class="btn primary-btn -white -sm" id="resendPhoneBtn" onclick="sendVerificationCode()">傳送驗證碼</a></span>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                            ...
                            <#--<form class="form-horizontal" id="" method="post" action="#">-->
                                ...
                                <div  style="display: none" class="form-group _change_password alterPwd">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control" name="forgetConfirmPassword" maxlength="20" placeholder="請確認密碼">
                                    </div>
                                </div>
                                <div  style="display: none"  class="form-group _change_password alterPwd">
                                    <label for="inputPassword" class="col-sm-3 control-label">驗證碼</label>
                            ...
                            <div class="tab-pane _success" id="step4" style="display: none">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 p-lg text-right">
                                        <a class="btn primary-btn -blue -sm afterReset" data-url="/?do=loginDialog">立即登入</a>
                                    </div>
                                    <div class="col-xs-6 p-lg">
                                        <a class="btn primary-btn -white -sm afterReset" data-url="/">返回首頁</a>
                                    </div>
                                </div>
                            </div>

...
<div class="game-list">
    ...
    <#if data.siteGameByApiType[apiType]?exists>
        <#list data.siteGameByApiType[apiType] as game>
            <div class="col-5-1">
                <div class="game-item ${gameItemBorderStyle!'s_default'}">
                    <div class="tags"><!--标签-->
                    ...
                    <figure class='${gameImageHover!"imghvr-fade"}'> <!--图片区域-->
                        ...
                        <#if (data.gameSearch.gameTag?default('')=="Jackpots" && data.gameSearch.apiId=="3") || (data.gameSearch.gameTag?default('')=="Jackpots" && data.gameSearch.apiId=="6")>

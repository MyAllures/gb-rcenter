...
<div class="container-fluid no-full">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h3 class="text-center text-white m-t-sm m-b-lg">代理商註冊</h3>
        </div>
    </div>
</div>
<!--Login-->
    ...
    <div class="row">
        <div class="signin-card col-md-8 col-md-offset-2 register">
                ...
                <#list data.agentFieldSorts as field>
                    <#if field.name == 'regCode'>
                        <div class="form-group" id="recommendBox">
                            <label for="appid" class="col-sm-2 control-label">介紹人</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="recommendUserInputCode" placeholder="請輸入介紹人">
                            </div>
                        </div>
                    </#if>
                </#list>
            ...
            <#if data.agentFieldSorts?has_content>
                <#list data.agentFieldSorts as field>
                    <#if field.name == 'username'>
                        <div class="form-group">
                            <label for="sysUser.username" class="col-sm-2 control-label">賬號</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="sysUser.username" maxlength="15" placeholder="請輸入4-15字元賬號">
                            </div>
                        </div>
                    </#if>
                    ...
                    <#if field.name == 'password'>
                        <div class="form-group">
                            <label for="sysUser.password" class="col-sm-2 control-label">登入密碼</label>
                            <div class="col-sm-10">
                    ...
                    <#--时区-->
                        <div class="form-group">
                            <label for="sysUser.defaultTimezone" class="col-sm-2 control-label">時區</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == 'sex'>
                        <div class="form-group">
                            <label for="sysUser.sex" class="col-sm-2 control-label">性別</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == 'nickName'>
                        <div class="form-group">
                            <label for="sysUser.nickname" class="col-sm-2 control-label">暱稱</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="sysUser.nickname" maxlength="30" placeholder="請輸入3-15個字元（由漢字和大小寫英文字母組成）">
                            </div>
                        </div>
                    </#if>
                    <#if field.name == 'defaultLocale'>
                        <div class="form-group">
                            <label for="sysUser.defaultLocale" class="col-sm-2 control-label">主語言</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == '304'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="weixin.contactValue" placeholder="請輸入微訊號">
                            </div>
                        </div>
                    </#if>
                    <#if field.name == '110'>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">手機</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="phone.contactValue" placeholder="請輸入正確的手機號">
                            </div>
                        </div>
                    </#if>
                    <#if field.name == '201'>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">郵箱</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="email.contactValue" placeholder="請輸入Email賬號">
                            </div>
                        </div>
                        <#if data.agentValidateRegisterMap['isEmailValid']?exists && data.agentValidateRegisterMap['isEmailValid']>
                            ...
                            <#--<div class="form-group">
                                <label for="inputPassword" class="col-sm-2 control-label">郵箱驗證碼</label>
                                <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="emailCode" maxlength="6" placeholder="郵箱驗證碼">
                                            <span class="input-group-btn"><a class="btn primary-btn -white -sm" onclick="validateEmailAddress(this)">獲取驗證碼</a></span>
                                        </div>
                                    </div>
                                </div>
                            </#if>
                    ...
                    <#if field.name == 'paymentPassword'>
                        <div class="form-group">
                            <label for="sysUser.permissionPwd" class="col-sm-2 control-label">安全密碼</label>
                            <div class="col-sm-10">
                                <input class="form-control noCp" maxlength="6" type="password" name="sysUser.permissionPwd">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="confirmPermissionPwd" class="col-sm-2 control-label">確認安全密碼</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == 'realName'>
                        <div class="form-group">
                            <label for="sysUser.realName" class="col-sm-2 control-label">真實姓名</label>
                            <div class="col-sm-10">
                    ...
                    <#--安全問題-->
                        <div class="form-group">
                            <label for="sysUserProtection.question1" class="col-sm-2 control-label">安全問題</label>
                            <div class="col-sm-10">
                    ...
                    <#--主貨幣-->
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="sysUser.defaultCurrency">主貨幣</label>
                            <div class="col-sm-10">
                    ...
                    <#if field.name == 'resource'>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="sysUser.constellation">推廣資源</label>
                            <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label for="inputPassword" class="col-sm-2 control-label">驗證碼</label>
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="hidden" name="regtype" value="a">
                            <input type="text" class="form-control input-lowercase" name="captchaCode" maxlength="4" placeholder="驗證碼">
                ...
                <div class="form-group">
                    <div class="col-sm-10 col-sm-offset-2">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" checked="checked"  value="checked" name="termsOfServiceCheck"> 我已屆滿合法博彩年齡，且已閱讀，接受並同意<a href="javascript:void(0);" id="login-agreement">代理註冊協議</a>
                            </label>
                        </div>
                        <input type="hidden" value="123123" name="termsOfService">
                    </div>
                </div>
                <button type="button" class="btn primary-btn -blue -lg" onclick="registerPlayer(this)">提交註冊</button>
            </form>
        </div>
        <div class="col-md-4 col-md-offset-4 text-center text-white m-t-sm">
            <p>已經是我們的代理?<a class="btn btn-link btn-lg no-vertical" href="${data.contextInfo.agentCenterContext}/passport/login.html">登入</a></p>
        </div>
    </div>
</div>
<!--Server Bar-->

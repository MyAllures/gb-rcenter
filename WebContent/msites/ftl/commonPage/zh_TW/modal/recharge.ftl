    ...
    <div class="col-12-12">
        <form class="form-horizontal" id="loginForm" method="post" action="#">
            <div class="row recharge-item">
                <div class="col-12-2 text">轉出</div>
                <div class="col-12-3 title">我的錢包</div>
                ...
                <div class="col-12-2">
                    <a class="btn btn-primary" data-win-size="2" target="_blank" href="${data.contextInfo.playerCenterContext}#/fund/playerRecharge/recharge.html">去存款</a>
                <#--<a class="btn btn-primary" href="">去充值</a>-->
                </div>
            </div>
            <div class="row recharge-item">
                <div class="col-12-2 text">轉入</div>
            ...
            <div class="row recharge-item">
                ...
                <div class="col-12-5 value">
                    <input type="text" class="form-control" id="transferAmount" name="transferAmount" placeholder="請輸入整數金額">
                    <span></span>
            ...
            <div class="row recharge-item">
                <div class="col-12-8 col-offset-12-2 sum-btn submit-btn-confirm">
                    <button class="btn btn-primary btn-block" type="button" id="confirm-btn" onclick="confirmTransction()">
                        <span class="gui gui-check-square-o"></span> 確認轉賬
                    </button>
                </div>
            </div>
            <div class="row recharge-item recharge-last ">
                <div class="col-12-8 col-offset-12-2 sum-btn enter-btn">
                    <button class="btn btn-success btn-block" type="button" onclick="enterToGame()"><span class="gui gui-share"></span> 進入遊戲</button>
                </div>
            </div>
        </form>
    </div>

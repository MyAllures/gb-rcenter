    ...
    j.prototype.view = function() {
        ...
        var g = function() {
            ...
            j = function() {
                ...
                if (c.btn[1] == '') {
                    return 0 !== b && c.btn ? (a = '<span type="0" style="display: none">' + c.btn[1] + "</span>", 2 === b && (a = '<span type="1" class="_submit">' + c.btn[0] + "</span>" + a), '<div class="layermbtn single"><div class="layer-disable"></div>' + a + "</div>") : "";
                } else {
                    return 0 !== b && c.btn ? (a = '<span type="0">' + c.btn[1] + "</span>", 2 === b && (a = '<span type="1">' + c.btn[0] + "</span>" + a), '<div class="layermbtn two"><div class="layer-disable"></div>' + a + "</div>") : "";
                }
            } ();
        if(!c.top) {
            c.top = Screen.Height / 2 - 100;
        }
        ...
        "function" == typeof define ? define(function() {
            ...
            var a = document.scripts,
                c = a[a.length - 1],
                d = c.src,
                e = d.substring(0, d.lastIndexOf("/") - 2);
            c.getAttribute("merge") || document.head.appendChild(function() {
                var a = b.createElement("link");
                return a.href = resRoot + "/themes/layer.css",
                    a.type = "text/css",
                    a.rel = "styleSheet",
                    a.id = "layermcss",
                    a

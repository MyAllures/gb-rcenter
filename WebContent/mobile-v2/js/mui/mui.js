    ...
    var PullRefresh = {
        init: function (element, options) {
            this._super(element, $.extend(true, {
                ...
                down: {
                    height: 50,
                    contentinit: window.top.message.common_auto['下拉可以刷新'],
                    contentdown: window.top.message.common_auto['下拉可以刷新'],
                    contentover: window.top.message.common_auto['释放立即刷新'],
                    contentrefresh: window.top.message.common_auto['正在刷新']
                },
                up: {
                    height: 50,
                    auto: false,
                    contentinit: window.top.message.common_auto['上拉显示更多'],
                    contentdown: window.top.message.common_auto['上拉显示更多'],
                    contentrefresh: window.top.message.common_auto['正在加载'],
                    contentnomore: window.top.message.common_auto['已经到底了'],
                    duration: 300
                }
            }, options));
        },

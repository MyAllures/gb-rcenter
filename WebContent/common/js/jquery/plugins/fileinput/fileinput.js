...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        updateFileDetails: function (numFiles) {
            var self = this, $el = self.$element, fileStack = self.getFileStack(),
                name = (fileStack.length && fileStack[0].name) || $el.val() || '',
        ...
        change: function (e) {
            ...
            if (isEmpty(tfiles) || tfiles.length === 0) {
                if (!isAjaxUpload) {
                    //TODO Remark By Tony, 解决选择文件时，点击取消，文件被清空的情况
                    //self.clear();
                }
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-outline btn-filter',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i> ',
        removeClass: 'btn btn-outline btn-filter',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i> ',
        cancelClass: 'btn btn-outline btn-filter',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i> ',
        uploadClass: 'btn btn-outline btn-filter',
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        minImageWidth: null,

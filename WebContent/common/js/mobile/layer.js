    ...
    j.prototype.view = function() {
        ...
        var g = function() {
            ...
            j = function() {
                ...
                if (c.btn[1] == '') {
                    return 0 !== b && c.btn ? (a = '<span type="0" style="display: none">' + c.btn[1] + "</span>", 2 === b && (a = '<span type="1" class="_submit">' + c.btn[0] + "</span>" + a), '<div class="layermbtn single">' + a + "</div>") : "";
                } else {
                    return 0 !== b && c.btn ? (a = '<span type="0">' + c.btn[1] + "</span>", 2 === b && (a = '<span type="1">' + c.btn[0] + "</span>" + a), '<div class="layermbtn two">' + a + "</div>") : "";
                }
            } ();
        if(!c.top) {
        ...
        "function" == typeof define ? define(function() {
            ...
            c.getAttribute("merge") || document.head.appendChild(function() {
                ...
                return a.href = root + resRoot + "/themes/layer.css",
                    a.type = "text/css",
                    a.rel = "styleSheet",
                    a.id = "layermcss",
                    a

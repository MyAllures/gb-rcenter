    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            function addFile(file) {
                ...
                var files= $("li",$filePickerBlock.parent());
                editor.execCommand('addFile', files);
            }
            ...
            uploader.on('all', function (type, files) {
                switch (type) {
                    ...
                    case 'startUpload':
                        /* 添加额外的GET参数 */
                        var params = utils.serializeParam(editor.queryCommandValue('serverparam')) || editor.getOpt('urlParam'),

...
(function () {
    var title = $G("J_title"),
        ...
        me,
        preview = $G("J_preview")
        /*table_tone_width = $G("J_tone_width"),
        table_tone_height = $G("J_tone_height");*/
    ...
    editTable.prototype = {
        init:function () {
            ...
            /*table_tone_width.value = me.getWidth();
            table_tone_height.value = me.getHeight();*/
        },
    ...
    dialog.onok = function () {
        ...
        /*if (table_tone_width.value) {
            if (me.getWidth() != table_tone_width.value) {
                editor.execCommand("edittableW",table_tone_width.value);
            }
        } else {
            editor.execCommand("edittableW",0);
        }

        if (table_tone_height.value) {
            if (me.getHeight() != table_tone_height.value) {
                editor.execCommand("edittableH",table_tone_height.value);
            }
        } else {
            editor.execCommand("edittableH",0);
        }*/

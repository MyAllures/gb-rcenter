    ...
    return Common.extend({
        ...
        renderViewRight: function (json) {
            var result = {
                ...
                lhh: {long: {name: '龙', num: 0}, hu: {name: '虎', num: 0}}
            };
            ...
            for (var i = 0; i < json.length; ++i) {
                ...
                if (num1 >= 11) {
                    result.qianwan.da.num++;
                    result.qianwan.xiao.num = 0;
                } else {
                    result.qianwan.da.num = 0;
                    result.qianwan.xiao.num++;
                }
                if (num1 % 2 == 0) {
                    result.qianwan.shuang.num++;
                    result.qianwan.dan.num = 0;
                } else {
                    result.qianwan.shuang.num = 0;
                    result.qianwan.dan.num++;
                }

                if (num2 >= 11) {
                    result.baiwan.da.num++;
                    result.baiwan.xiao.num = 0;
                } else {
                    result.baiwan.da.num = 0;
                    result.baiwan.xiao.num++;
                }
                if (num2 % 2 == 0) {
                    result.baiwan.shuang.num++;
                    result.baiwan.dan.num = 0;
                } else {
                    result.baiwan.shuang.num = 0;
                    result.baiwan.dan.num++;
                }
            ...
            var arr = [];
            arr.push(result.qianwan.da);
            arr.push(result.qianwan.xiao);
            arr.push(result.qianwan.dan);
            arr.push(result.qianwan.shuang);
            arr.push(result.baiwan.da);
            arr.push(result.baiwan.xiao);
            arr.push(result.baiwan.dan);
            arr.push(result.baiwan.shuang);

define(['site/hall/k3/PlayWay-gfwf', 'site/plugin/template'], function (PlayWay, Template) {
    ...
    return PlayWay.extend({
        ...
        showTable : function(){
            ...
            $("#toobarTitle").text("官方玩法-二同号单选");
            if (this.os == 'app_android' && isLotterySite == 'true') {
                window.gamebox.setTitle('官方玩法-二同号单选');
            }
            $(".x_3.gfwf-playName").text("二同号单选");
            $(".s-title.title2 span").text("二同号单选")
            $("a[data-code='bzxh'] span").text("二同号单选");
        },

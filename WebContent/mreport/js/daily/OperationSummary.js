    ...
    return MReport.extend({
        ...
        rakebackTrend:function(rangeType,operationSummarys) {
            ...
            if('rakeback-men' == rakebackType) {
                this.drawBasicColumnChart('b7', operationSummarys, 'rakebackPlayer', 'staticDay*rakebackPlayer', '返水人数', 379);
            } else if('rakeback-cash' == rakebackType) {
                this.drawBasicColumnChart('b7', operationSummarys, 'rakebackAmount', 'staticDay*rakebackAmount', '返水金额', 356);
            }
        },

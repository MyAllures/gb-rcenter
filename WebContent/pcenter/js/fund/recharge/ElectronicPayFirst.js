 ...
 * 管理首页-首页js
 */
define(['common/BasePage', 'site/fund/recharge/RealName'], function (BasePage, RealName) {
    return BasePage.extend({
        ...
        submit: function (e, option) {
            ...
            var url = root + "/fund/recharge/company/electronicPaySecond.html?result.payAccountId=" + payAccount;
            $("#mainFrame").load(url);
        },
        /**
         * 客户服务

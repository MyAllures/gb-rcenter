    ...
    return BaseEditPage.extend({
        ...
        validRemainCount:function (e,opt,fromSaveBtn) {
            ...
            window.top.topPage.ajax({
                url: root + '/activityHall/activityMoneyDefaultWin/fetchActivityAwardsRules.html?id='+awardsId,
                dataType: "json",
        ...
        cancelDefaultWin: function (e,opt) {
            ...
            var id = opt.dataId;
            window.top.topPage.ajax({
                url: root + '/activityHall/activityMoneyDefaultWin/cancelDefaultWin.html',
                data: {"search.id": id},
                dataType: "json",
                success: function (data) {
                    if (data.state) {
        ...
        isPlayerWin:function (e, opt) {
            ...
            var id = opt.dataId;
            window.top.topPage.ajax({
                url: root + '/activityHall/activityMoneyDefaultWin/hasUseDefaultWinPlayer.html',
                data: {"search.id": id},
                success: function (data) {

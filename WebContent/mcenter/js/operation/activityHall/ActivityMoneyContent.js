    ...
    return BaseEditPage.extend({
        ...
        queryHasDisplayActivity:function (e, opt) {
            ...
            window.top.topPage.ajax({
                url: root + "/activityHall/activity/queryExistMoneyActivity.html?id="+$("#activityMessageId").val(),
                type: "POST",
                dataType: "JSON",
        ...
        validatePeriodArea:function (e,hasNextValid,opt) {
            var _this = this;
            var url = root + '/activityHall/activity/validatePeriodArea.html';
        ...
        queryRemainCount:function () {
            ...
            window.top.topPage.ajax({
                url: root + "/activityHall/activityMoneyAwardsRules/queryAwardRemainCount.html?search.activityMessageId="+activityMessageId,
                type: "POST",
                dataType: "JSON",

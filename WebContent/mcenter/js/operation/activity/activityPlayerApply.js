    ...
    return BaseListPage.extend({
        ...
        successDialog: function (e) {
            ...
            if (ids != "") {
                ...
                var btnOption = {};
                btnOption.target = root + "/operation/vActivityPlayerApply/successDialog.html?code="+code+"&ids=" + ids +"&sumPerson="+sumPerson;
        ...
        failDialog: function (e,opt) {
            ...
            if (ids != "") {
                ...
                var btnOption = {};
                btnOption.target = root + "/operation/vActivityPlayerApply/failDialog.html?ids=" + ids + "&search.activityName=" + activityName + "&search.activityTypeCode=" + activityTypeCode;
                btnOption.callback = this.back;
                btnOption.text = e.currentTarget.title;
                window.top.topPage.doDialog(e, btnOption);
            }
        ...
        hasFailReason: function (e,opt) {
            ...
            window.top.topPage.ajax({
                type: 'POST',
                url: root + "/operation/vActivityPlayerApply/hasReason.html",
                dataType: "json",

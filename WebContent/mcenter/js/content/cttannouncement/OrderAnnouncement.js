    ...
    return BaseEditPage.extend({
        ...
        saveSiteApiOrder: function(e,option) {
            ...
            $("tbody tr").each(function(index,obj){
                orderObj.push({"order":index+1,"objectId":$(obj).children("[name='announcementType']").val()});
                announcementOrder.orderList = orderObj;
            });
            window.top.topPage.ajax({
                contentType: 'application/json; charset=utf-8',
                dataType:'json',
                data:JSON.stringify(announcementOrder),
                async:false,
                type:"post",
                url:root+'/cttAnnouncement/saveCttAnnouncementOrder.html',

    ...
    return BaseListPage.extend({
        ...
        reWrite: function () {
            ...
            if (selectedJson != '') {
                ...
                $(this.formSelector + " #chooseGameType .input-group").find("span[prompt=prompt]").text(window.top.message.report_auto['已选择'] + count + window.top.message.report_auto['项']);
        ...
        apiVal: function (e) {
            ...
            if (arr && arr.length > 0) {
                ...
                if (selectGame.length > 0) {
                    ...
                    $("#chooseGameType").children(".input-group").find("span[prompt='prompt']").text(window.top.message.report_auto['已选中'] + len + window.top.message.report_auto['项']);
                }
            } else {
        ...
        resetCondition: function (e) {
            ...
            $("input[name='search.terminal']").siblings("button").find("span[prompt='prompt']").text(window.top.message.player_auto['全部']);

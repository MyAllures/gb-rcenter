define(['common/BaseListPage'], function(BaseListPage) {
     return BaseListPage.extend({
         ...
         initCheckboxSelected: function () {
             $('input:checkbox[cktype="parent"]').each(function (idx, item) {
                 if(!item.checked){
                     var type = $(item).attr("noticeType");
                     var flag = false;
                     $('input:checkbox[parentCode="'+type+'"]').each(function (ix,child) {
                         if(child.checked){
                             flag = true;
                         }
                     });
         ...
         onCheckParent: function () {
             var _this = this;
             $('input:checkbox[cktype="parent"]').each(function (idx, item) {
                 var type = $(item).attr("noticeType");
                 $(item).click(function () {
                     if(!item.checked){
                         if(!_this.isAllCancel(type)){
                             item.indeterminate = true;
                         }else{
             ...
             $('input:checkbox[cktype="parent"]').each(function (idx, item) {
                 ...
                 $('input:checkbox[parentCode="'+type+'"]').each(function (ix,child) {
                     $(child).click(function () {
                         if(_this.isAllCancel(type)){
                             if(item.checked==false&&item.indeterminate){
                                 item.indeterminate = false;
                             }
                         }else{

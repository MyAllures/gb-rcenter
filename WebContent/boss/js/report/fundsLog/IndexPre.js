    ...
    return BaseListPage.extend({
       ...
       // selectPure:null,
        ...
        querySiteUserName: function (e) {
            ...
            var btn_companySite = $("[name=csiteId]");
            ...
            $("#searchBtn").on("click", function (e) {
                ...
                if($form.valid()){
                    window.top.topPage.ajax({
                        type: "post",
                        url: root+"/report/fundsLog/fundsList.html",
                        headers: {
                            "Soul-Requested-With": "XMLHttpRequest"
                        },
                        data: {
                            "mastername": $("input[name='masterName']").val(),
                            'companyId': $("[name=csiteId]").val() //运营商站点id
                        },
        ...
        changeCenter: function (e) {
            var siteId = $('[name=csite_' + e.key + ']').val();
            $('[name=csiteId]').val(siteId);
        }

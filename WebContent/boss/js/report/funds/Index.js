    ...
    return BaseListPage.extend({
        ...
        bindEvent: function () {
            ...
            $("input[name='search.playerRanks']",_that.formSelector).change(function (e) {
                ...
                if(rankLength==0){
                    $(this).parents(".dropdown-menu").siblings("button").children(".rankText").text("请选择");
                }else{
                    $(this).parents(".dropdown-menu").siblings("button").children(".rankText").text("已选" + rankLength + "项");
                }

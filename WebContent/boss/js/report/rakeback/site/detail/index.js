...
define(['common/BaseListPage'], function (BaseListPage) {
    ...
    return BaseListPage.extend({
        ...
        changePeriod: function(year, month, $period) {
            if (month) {
                window.top.topPage.ajax({
                    url: root + '/report/rakeback/site/detail/ajaxPeriods.html',
                    dataType: 'json',
                    type: 'POST',
        ...
        siteChange: function(e) {
            ...
            var $this = this;
            window.top.topPage.ajax({
                url: root + '/report/rakeback/site/detail/ajaxYears.html',
                dataType: 'json',
                type: 'POST',
                data: {'siteId': e.key},
                success: function(data) {
        ...
        validateData: function (e,opt) {
            if($("[name='paging.totalCount']").val()==0){
                window.top.topPage.showWarningMessage(window.top.message.report['qi']);

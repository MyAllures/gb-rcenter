 ...
 * 管理首页-首页js
 */
define(['common/BasePage', 'site/site/syssite/detail/homepage/include/Chart', 'site/site/syssite/detail/homepage/include/Table', 'inspinia'], function (BasePage, chart, table) {
    return BasePage.extend({
        ...
        loadOperateData: function () {
            ...
            window.top.topPage.ajax({
                url: root + '/site/detail/operateData.html?t=' + new Date().getTime(),
                dateType: 'html',
        ...
        effectiveData : function () {
            var _this=this;
            window.top.topPage.ajax({
                url: root + '/site/detail/effectiveData.html',
                dateType: 'html',
                success: function (data) {
                    $("#effective").html(data);

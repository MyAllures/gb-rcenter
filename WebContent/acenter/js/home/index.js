...
define(['common/BasePage', 'site/home/include/Chart', 'site/home/include/Table', 'inspinia'], function (BasePage, chart, table) {
    return BasePage.extend({
        ...
        openMoreAgent: function(e) {
            $('div#domainAgent').removeAttr('style');
            $('div#openMoreAgent').hide();
            $('div#hideMoreAgent').show();
            $(e.currentTarget).unlock();
        },
        hideMoreAgent: function(e) {
            $('div#domainAgent').css({'height':'150px', 'overflow':'hidden'});
